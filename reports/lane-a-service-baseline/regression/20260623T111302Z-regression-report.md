...
> vitest run
 ...
 Test Files  3 passed (3)
      Tests  9 passed (9)
   Start at  19:13:23
   Duration  245ms (transform 229ms, setup 0ms, import 275ms, tests 12ms, environment 0ms)
...
> vitest run
 ...
 Test Files  1 passed (1)
      Tests  7 passed (7)
   Start at  19:13:23
   Duration  231ms (transform 49ms, setup 0ms, import 101ms, tests 8ms, environment 0ms)
...
> vitest run
 ...
 Test Files  1 passed (1)
      Tests  8 passed (8)
   Start at  19:13:24
   Duration  233ms (transform 62ms, setup 0ms, import 107ms, tests 15ms, environment 0ms)
...
> vitest run
 ...
 Test Files  1 passed (1)
      Tests  3 passed (3)
   Start at  19:13:25
   Duration  257ms (transform 69ms, setup 0ms, import 120ms, tests 10ms, environment 0ms)
...
> vitest run
 ...
 ❯ src/modules/handoff/handoff.e2e.test.ts (6 tests | 1 failed) 242ms
     × delivers a pending Dev -> QA handoff when the QA endpoint reconnects 51ms

⎯⎯⎯⎯⎯⎯⎯ Failed Tests 1 ⎯⎯⎯⎯⎯⎯⎯

 FAIL  src/modules/handoff/handoff.e2e.test.ts > Handoff Hub API > delivers a pending Dev -> QA handoff when the QA endpoint reconnects
Error: expected 200 "OK", got 404 "Not Found"
 ❯ src/modules/handoff/handoff.e2e.test.ts:119:8
    117|       .post(`/deliveries/${deliveryId}/ack`)
    118|       .send({ schema_version: "1.0" })
    119|       .expect(200)
       |        ^
    120|       .expect(({ body }) => {
    121|         expect(body.delivery.status).toBe("acknowledged");
...
⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯[1/1]⎯
 ...
 Test Files  1 failed | 3 passed (4)
   ...
   Start at  19:13:26
   Duration  928ms (transform 314ms, setup 0ms, import 965ms, tests 311ms, environment 0ms)
...
> vitest run
 ...
 Test Files  4 passed (4)
      Tests  27 passed (27)
   Start at  19:13:27
   Duration  2.01s (transform 262ms, setup 0ms, import 600ms, tests 829ms, environment 795ms)
...
> vitest run scripts/web-console-hub-real-smoke.test.ts
 ...
 Test Files  1 passed (1)
      Tests  1 passed (1)
   Start at  19:13:30
   Duration  743ms (transform 150ms, setup 0ms, import 402ms, tests 231ms, environment 0ms)
...
Checked 68 files in 51ms. No fixes applied.
```
