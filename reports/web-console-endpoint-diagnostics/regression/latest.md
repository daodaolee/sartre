# Regression Report: web-console-endpoint-diagnostics

- Timestamp: 20260623T105600Z
...
- Evidence: `STRUCTURAL_CHECK`
- Command: `bash -lc test -f bdd/features/web-console-endpoint-diagnostics.md && test -f acceptance/checklists/web-console-endpoint-diagnostics.md && test -f reports/web-console-endpoint-diagnostics/checkpoints/PLAN_LEDGER.md`
...
> vitest run
 ...
 Test Files  3 passed (3)
      Tests  24 passed (24)
   Start at  18:56:02
   Duration  1.54s (transform 205ms, setup 0ms, import 442ms, tests 583ms, environment 614ms)
...
dist/assets/index-1qqK2til.css   19.91 kB │ gzip:  3.70 kB
dist/assets/index-MLp8JQVW.js   290.62 kB │ gzip: 86.29 kB
✓ built in 737ms
```
...
Checked 66 files in 49ms. No fixes applied.
```
...
- Command: `n/a`
- Result: SKIP
- Reason: not part of Web Console endpoint diagnostics scoped gate; known historical blockers remain outside this goal.
