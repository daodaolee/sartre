# Regression Report: web-console-agent-reconnect-control

- Timestamp: 20260623T104649Z
...
- Evidence: `STRUCTURAL_CHECK`
- Command: `bash -lc test -f bdd/features/web-console-agent-reconnect-control.md && test -f acceptance/checklists/web-console-agent-reconnect-control.md && test -f reports/web-console-agent-reconnect-control/checkpoints/PLAN_LEDGER.md`
...
> vitest run
 ...
 Test Files  2 passed (2)
      Tests  20 passed (20)
   Start at  18:46:51
   Duration  1.89s (transform 182ms, setup 0ms, import 450ms, tests 623ms, environment 810ms)
...
## Web Console agent reconnect scoped diff check

- Evidence: `REAL_TEST`
- Command: `git diff --check -- apps/web-console scripts/harness-regression.sh openspec/changes/web-console-agent-reconnect-control bdd/features/web-console-agent-reconnect-control.md acceptance/checklists/web-console-agent-reconnect-control.md plan/web-console-agent-reconnect-control-goal.md reports/web-console-agent-reconnect-control/checkpoints`
...
- Command: `n/a`
- Result: SKIP
- Reason: not part of Web Console agent reconnect scoped gate; known historical blockers remain outside this goal.
